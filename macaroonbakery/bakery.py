...
from macaroonbakery.checkers import checkers as checkers
...
class Bakery(object):
    ...
    def __init__(self, location=None, locator=None, ops_store=None, key=None,
        ...
        oven = macaroonbakery.Oven(key=key,
                                   location=location,
                                   locator=locator,
        ...
        self._checker = macaroonbakery.Checker(checker=checker, authorizer=authorizer,
